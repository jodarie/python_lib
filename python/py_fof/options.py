...
def cosmo(parser):
    ...
    parser.add_option("--c", dest = "c", type = "float", default = 2.998e5, help = "Speed of light. [Default: %default]")
...
def fof(parser):
    ...
    parser.add_option("--tree_dist", dest = "tree_dist", type = "float", default = 90,
