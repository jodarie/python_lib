...
def usage():
   print 'test.py -i <input_file> -o <output_file> -b <bin_size>'
   exit(-1)
...
def main(argv):
   ...
   def read_params(param_file):
      ...
      return cluster_file,mock_file,c_id_col,cg_id_col,m_id_col,mg_id_col,m_mass_col,match_threshold,rich_bin_size,max_rich_bin,min_rich_bin
   ...
   try:
      opts, args = getopt.getopt(argv,"c:m:p:a:b:c:d:e:f:g:h:i:j",["cfile=","hfile=","pfile=","c_id_col=","cg_id_col=",
                                                               "m_id_col=","mg_id_col=","m_mass_col=","binsize=",
         "match_threshold=","rich_bin=","max_rich_bin=","min_rich_bin=","help"])
   ...
   for opt, arg in opts:
      if opt in ('-h','--help'):
         ...
         param_file = arg
         cluster_file,mock_file,c_id_col,cg_id_col,m_id_col,mg_id_col,m_mass_col,match_threshold,rich_bin_size,max_rich_bin,min_rich_bin = read_params(param_file)
   ...
   match_out_file = cluster_file + '_matching.txt'
   ...
   match_bin_file = cluster_file + '_matching_bin.txt'
   ...
   ax1.plot(x_rich_vals,complete_bin_1,linewidth=1.5,c='b',label='One-Way')
   ax1.plot(x_rich_vals,complete_bin_2,linewidth=1.5,c='r',label='Two-Way')
   ...
   ax2.plot(x_rich_vals,pure_bin_1,linewidth=1.5,c='b',label='One-Way')
   ax2.plot(x_rich_vals,pure_bin_2,linewidth=1.5,c='r',label='Two-Way')
   ...
   ax3.plot(x_rich_vals,g1_bin,linewidth=1.5,c='g')
   ...
   ax4.plot(x_rich_vals,g2_bin,linewidth=1.5,c='g')
