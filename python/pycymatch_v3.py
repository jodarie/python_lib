...
parser.add_option("--mock_plots", action = "store_true", dest = "make_mock_plots",
                  help = "Ouput plots of the mock catalogue properties." )
...
if opts.max_z_bin < 0: opts.max_z_bin = max(mock.z)
...
im = ax61.imshow(complete_bin_mass, extent = [opts.min_z_bin, opts.max_z_bin, opts.min_mass_bin, opts.max_mass_bin], aspect = 'auto',
                 interpolation=interpolation, cmap = colormap, norm = normalisation)
ax61.set_xlabel('z')
